...
/* ================= POPUP EFFECT (FIXED) ================= */
/* Visible full time, non-blocking, no layout break */
...
/* ================= FINAL PAGE (AUTO SCROLL RESTORED) ================= */
...
function renderFinal() {
    screen.innerHTML = `
        <div class="final-scroll-container" id="scrollBox">
            ...
            <button class="primary" onclick="startCountdown()">
                View Secret Message 💌
            </button>
        </div>
    `;
...
function renderSecret() {
    screen.innerHTML = `
        <h1>💖 Secret</h1>
        <p>Just for you 😘</p>
        <button class="primary" onclick="location.href='YOUR_LINK_HERE'">
            Continue 💌
        </button>
    `;
}
